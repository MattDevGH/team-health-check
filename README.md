...
1. **Auth/session and audit contracts:** remaining team export/session-detail/
   participation authorization, direct AuthContext documentation, micro-pulse
   selection, reused-session close scoping, and the still-missing
...
```bash
npm test            # unit + property tests (992 tests across 121 Vitest files)
