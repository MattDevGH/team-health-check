...
- [ ] 1. Foundation: Error handling, validation, and shared infrastructure
  - [ ] 1.1 Create AppError base class and typed error subclasses
  ...
  - [ ]* 1.3 Write property tests for validation schemas
  ...
  - [ ] 1.4 Create `withErrorHandling` route handler wrapper
  ...
  - [ ]* 1.5 Write property test for API error response format consistency
  ...
  - [ ] 1.6 Create rate limiter utility
  ...
  - [ ] 1.7 Install dependencies and update Prisma schema
...
- [ ] 2. Repository layer: interfaces and in-memory fakes
  ...
  - [ ] 2.2 Implement in-memory TeamRepository and TeamMemberRepository fakes
  ...
  - [ ] 2.3 Implement in-memory SessionRepository and ResponseRepository fakes
  ...
  - [ ] 2.4 Implement remaining in-memory repository fakes
  ...
  - [ ] 2.5 Create repository factory and index
...
- [ ] 4. Team management service
  ...
  - [ ] 4.1 Implement team creation (TeamService.create)
  ...
  - [ ]* 4.2 Write property test for team creation data preservation
  ...
  - [ ] 4.3 Implement add team member (TeamService.addMember)
  ...
  - [ ]* 4.4 Write property test for team member uniqueness
  ...
  - [ ] 4.5 Implement remove team member (TeamService.removeMember)
  ...
  - [ ]* 4.6 Write property test for member removal preserving responses
  ...
  - [ ] 4.7 Implement team archive and unarchive
  ...
  - [ ]* 4.8 Write property test for archive/unarchive round-trip
  ...
  - [ ] 4.9 Implement getMembers and list teams
...
- [ ] 5. Roles and permissions service
  ...
  - [ ] 5.1 Implement role assignment and removal
  ...
  - [ ] 5.3 Implement permission check middleware
  ...
  - [ ] 5.4 Implement genesis creation flow with atomic CAS verification
...
- [ ] 7. Session lifecycle service

  - [ ] 7.1 Implement session open (SessionService.open)
  ...
  - [ ]* 7.2 Write property tests for session invariants
  ...
  - [ ] 7.3 Implement session close (SessionService.close)
  ...
  - [ ] 7.4 Implement session link generation
  ...
  - [ ]* 7.5 Write property test for session link generation
  ...
  - [ ] 7.5 Implement aggregate materialisation
  ...
  - [ ]* 7.6 Write property test for session average computation
  ...
  - [ ] 7.7 Implement schedule configuration
...
- [ ] 8. Response submission service
  ...
  - [ ] 8.1 Implement response upsert (ResponseService.upsert)
  ...
  - [ ]* 8.2 Write property test for response upsert idempotency
  ...
  - [ ]* 8.3 Write property tests for submission access control
  ...
  - [ ] 8.4 Implement rolling average calculation
